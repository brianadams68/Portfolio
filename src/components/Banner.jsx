    ...
    <section className="banner" id="home">
      <Container>
        <Row className="align-items-center">
          <Col xs={12} md={6} xl={7}>
            <span className="tagline">Welcome to my Portofilio</span>
            <h1>
              {`Hi I'm Brian `} <span className="wrap">{text}</span>{" "}
            </h1>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis rem
              eveniet soluta dolorum odit, sint adipisci, veritatis minima aut
              earum repellendus obcaecati nulla? Dolor id sequi labore,
